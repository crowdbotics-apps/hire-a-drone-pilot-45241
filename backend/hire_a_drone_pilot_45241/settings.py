"""
Django settings for hire_a_drone_pilot_45241 project.
...
ROOT_URLCONF = 'hire_a_drone_pilot_45241.urls'
...
WSGI_APPLICATION = 'hire_a_drone_pilot_45241.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hire_a_drone_pilot_45241 API",
    "DESCRIPTION": "API documentation for hire_a_drone_pilot_45241 App",
    "VERSION": "v1",
}
